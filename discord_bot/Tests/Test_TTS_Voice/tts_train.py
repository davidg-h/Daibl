...
def main():
    ...
    dataset_config = BaseDatasetConfig(
        formatter="ljspeech",
        meta_file_train="discord_bot\TTS_Bot\Train_Voice\Dataset_Generation\dataset\LJSpeech-1.1_David_dataset\metadata.csv",
        path="discord_bot\TTS_Bot\Train_Voice\Dataset_Generation\dataset\LJSpeech-1.1_David_dataset",
    )
    ...
    train_samples, eval_samples = load_tts_samples(
        ...
        eval_split_size=0.14285714285714285,
    )
